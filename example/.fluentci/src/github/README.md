...
The following command will generate a `.github/workflows/terraform-migrate.yml` file in your project:

```bash
fluentci gh init -t terraform_pipeline
```

Or, if you already have a `.fluentci` folder (generated from `fluentci init -t terraform`) in your project:
